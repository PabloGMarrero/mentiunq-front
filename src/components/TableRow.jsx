import { Tr, Td, Link, Menu, MenuButton, MenuList, MenuItem, MenuDivider, IconButton, Flex, Text, propNames } from '@chakra-ui/react'
            ...
            <>
                <Flex bg="white" justifyContent="left" flexDir={"column"} gap={"10px"}>
                    <Flex flexDir={"column"} >
                        <Flex gap={"5px"} >
                            <Text as='b'>
                                Copiar link de votación: 
                            </Text>                            
                        </Flex>
                        <Flex gap={"5px"} >
                            {window.location.href.slice(0, window.location.href.lastIndexOf('/'))+"/"+props.form.codeShare}
                        </Flex>
                    </Flex>
                    <Flex gap={"5px"} >
                        <Text as='b'>
                    ...
                    <QRCode value={window.location.href.slice(0, window.location.href.lastIndexOf('/'))+"/"+props.form.codeShare} />
                </Flex>
            </>
        )
                ...
                <Td>
                    <Menu>
                        ...
                        <MenuList>
                            ...
                            <MenuItem color="red.500" onClick={handleOpenShowDelete}>Borrar</MenuItem>
                            <ModalWindow 
                                show={showDelete} 
