          ...
          <Stack p={2} spacing={8} direction="row">
            {(() => {
              ...
              for (let question in currentQuestions) {
                indents.push(
                  <Box
                    key={currentQuestions[question].id}
                    p={5}
                    w="30%"
                    h="30vh"
                    shadow="md"
  ...
  return (
    <Flex flexDir={"column"} w="100%">
      ...
      <VStack w="100%" h="90vh" spacing={8}>
        <Heading w="50%" textAlign={"left"} fontSize="4xl" mt={4}>
        ...
        >
          <Heading fontSize="xl" mt={4}>
            Estadísticas de la presentación
          </Heading>
        ...
        >
          ...
          <Stack spacing={8} direction="row">
            <Card
              wide="33.3%"
              title={contentSlidesAmount}
              desc={"Slides Contenido"}
            />
            <Card
              wide="33.3%"
              title={openSlidesAmount}
              desc={"Slides Abiertas"}
            />
            <Card
              wide="33.3%"
              title={closedSlidesAmount}
              desc={"Slides Cerradas"}
            />
          </Stack>
        </Box>
        <Box
        ...
        >
          ...
          {(() => {
            ...
            while (tempQuestions.length > 0) {
              indents.push(
                <CardList
                  key={tempQuestions.at(0).id}
                  currentQuestions={tempQuestions.slice(0, 3)}
                />,
              )
